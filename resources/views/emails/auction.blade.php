...
<p>Congratulations! You've won the auction with an AU <font size="5">{{ $price }}</font>  Next, please make a payment to receive your item.</p>
<p>You placed {{ $bid_num }} bids and beat {{ $user_count }} bidders.</p>
<center><img src="{{ $images }}" alt="{{ $auction_name }}" width="300" height="300"/></center>
